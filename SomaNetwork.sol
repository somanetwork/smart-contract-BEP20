...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa620a0866d0739c78dbB01CE62e1cCB0c3253d79;
...
contract SomaNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xC77FB0Eab9c872EFD3B5C72AE77c048dBB165C34);
    ...
    */
    ...
    string  private _name       = "SOMA NETWORK"; 
    ...
    */
    ...
    SOMA STANDARD ERC20 COMPLIANCE FUNCTIONS
    ...
    */
    ...
    function _transfer(
        ...
        SOMA TRANSACTION AND WALLET LIMITS
        ...
        */
        ...
        SOMA REMOVE FEES IF REQUIRED

        Fee removed if the to or from address is excluded from fee.
        Fee SOMA removed if the transfer is NOT a buy or sell.
    ...
    SOMA PROCESSING FEES

    Fees are added to the contract as tokens, these functions exchange the tokens for BNB and send to the wallet.
    One wallet is used for ALL fees. This includes liquidity, marketing, development costs Soma etc.
    ...
    */
    ...
    SOMA PURGE RANDOM TOKENS - Add the random token address and a wallet to send them to
    ...
    */
    ...
    SOMA UPDATE PANCAKESWAP ROUTER AND LIQUIDITY PAIRING
